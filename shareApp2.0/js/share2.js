...
function toshare2(temp) {
	$.ajax({
		url: $.cookie("tempUrl") + "/commodity/getInfo.do?token=" + $.cookie("token") + "&id="+id,
		type: "GET",
	...
	$.ajax({
		url: $.cookie("tempUrl") + "/newShare/commodityShare.do?token=" + $.cookie("token") + "&commodityId=" + id,
		type: "POST",
		success: function(result) {
			if(result.code == 0) {
//				url = result.data;
