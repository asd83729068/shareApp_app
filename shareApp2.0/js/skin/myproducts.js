$(function () {
 ...
 $(function () {
    $.ajax({
        url:  getCookie("tempUrl")+"commodity/getCommodityGroupByTypeId?pageNum=1&pageSize=99&token="+getCookie("token")+"&memberId="+getCookie("id"),
        type: "GET",
...
function toinfo() {
	...
	$.ajax({
		url:  getCookie("tempUrl")+"commodity/getCommodityShareLikeName?imagename="+commodityName+"&token="+getCookie("token")+"&type=2",
		type: "POST",
		success: function(result) {
